...
- Can use Model Context Protocol (MCP) servers for extended capabilities
- Browser tool available for web research and documentation lookup
- Use these tools when standard code analysis isn't sufficient